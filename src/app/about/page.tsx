    ...
    <div className="min-h-screen bg-gray-900 text-white pb-12">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold mb-6">
              Our Mission: Connect Students With Local Experts
            </h1>
            <p className="text-xl mb-8">
              We're building a platform that makes it easy to discover and book
              personalized experiences with local guides who are passionate
              about sharing their culture, history, and hidden gems.
            </p>
        ...
        <div className="md:flex md:items-center md:space-x-12">
          ...
          <div className="md:w-1/2">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                TourGuide Connect was born from a simple idea: travel is better
                with local insights. Our founders, Alex and Maya, experienced
                this firsthand during their backpacking trip across Southeast
                Asia in 2018.
              </p>
              <p>
                While in Vietnam, they met Linh, a university student who
                offered to show them around Hanoi for a day. That experience
                completely transformed their trip - they discovered hidden
                cafés, learned about local customs, and gained insights they
                never would have found in any guidebook.
              </p>
              <p>
                Inspired by this experience, they created TourGuide Connect - a
                platform that connects students with passionate local guides
                around the world, making every journey more authentic and
                meaningful.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-gray-300">
              These core principles guide everything we do, from how we build
              our platform to how we support our community of guides and
              students.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-700 rounded-lg p-8 shadow-lg">
              ...
              <p className="text-gray-300">
                We believe in fostering genuine connections between students and
                local guides, creating meaningful cultural exchanges that
                benefit both.
              </p>
            </div>
            ...
            <div className="bg-gray-700 rounded-lg p-8 shadow-lg">
              ...
              <p className="text-gray-300">
                We're committed to promoting sustainable travel practices that
                respect local communities, preserve cultural heritage, and
            ...
            <div className="bg-gray-700 rounded-lg p-8 shadow-lg">
              ...
              <p className="text-gray-300">
                We prioritize the safety of our community through thorough
                vetting processes, secure payments, and tools that build trust
                between guides and students.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-gray-300">
            Meet the passionate team behind TourGuide Connect, dedicated to
            transforming how people explore the world.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-300">
              Former product manager and avid student who's visited 50+
              countries.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-300">
              Tech innovator building seamless experiences for guides and
              students.
            </p>
          </div>
      ...
      <section className="bg-orange-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Whether you're a student seeking authentic experiences or a guide
            eager to share your local expertise, join us in building a more
            connected world.
          </p>
