          ...
          <div className="md:w-1/2 p-6">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium">
                    {tour.guideId?.name || "Guide Name"}
                  </p>
                  <p className="text-sm text-gray-600">
                    <span className="text-yellow-500">★</span>{" "}
                    {tour.guideId?.rating || "4.5"} (
                    {tour.guideId?.reviewCount || "0"} reviews)
                  </p>
                </div>
              </div>
            </div>
            ...
            <Link
              href={`/student/booking/new?tourId=${tour._id}`}
        ...
        <div className="p-6 border-t">
          ...
          <div>
            ...
            <p className="text-gray-700">
              The tour will start at the specified location in {tour.location}.
              Detailed meeting instructions will be sent after booking.
            </p>
          </div>
        </div>
      </div>
