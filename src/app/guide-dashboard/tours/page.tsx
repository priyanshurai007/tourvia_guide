...
export default function ToursManagement() {
  ...
  const filteredTours = tours.filter((tour) => {
    ...
    const matchesStatus =
      statusFilter === "all" ||
      tour.status.toLowerCase() === statusFilter.toLowerCase();
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {sortedTours.map((tour) => (
                    <div
                      key={tour.id}
                      className="bg-gray-700 rounded-lg overflow-hidden border border-gray-600 shadow-md hover:shadow-lg transition-all hover:translate-y-[-2px]"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-400">
                      ...
                      Draft tours won't be visible to students
                    </p>
                  </div>
                </div>
                      ...
                      {imagePreview ? (
                        <div className="relative">
                          ...
                          <div className="mt-2 text-xs text-gray-400">
                            {formData.image &&
                              `${formData.image.name} (${Math.round(
                                formData.image.size / 1024
                              )} KB)`}
                          </div>
                          <button
                            type="button"
