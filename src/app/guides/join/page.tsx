        ...
        >
          ...
          >
            ...
            <p className="text-xl max-w-3xl">
              Share your passion for your city, earn income, and help students
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {success ? (
            ...
            >
              ...
              >
                Thank you for applying to be a guide on Find Your Best Guide.
                  ...
                  >
                    ...
                    {step < 3 ? (
                      ...
                      <motion.button
                        ...
                        whileHover={
                          !isSubmitting
                            ? { scale: 1.05, backgroundColor: "#c2410c" }
                            : {}
                        }
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Set your own rates and schedule. Keep 80% of what you
                    charge.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Showcase the best of your city and culture in your own
                    unique way.
                  </p>
                </motion.div>
              </div>
