...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        for (let i = 0; i < 3; i++) {
          try {
            ...
            if (
              ...
              console.warn(
                "Tour model not found in ping response, retrying..."
              );
        ...
        if (!pingSuccessful) {
          console.warn(
            "Could not verify model registration via ping, continuing anyway..."
          );
        }
  ...
  const removeSavedGuide = async (guideId: string) => {
    ...
    try {
      ...
      setUserData({
        ...userData,
        savedGuides: userData.savedGuides.filter(
  ...
  const cancelBooking = async (bookingId: string) => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json();
        throw new Error(
          errorData.error || errorData.message || "Failed to cancel booking"
        );
      }
            ...
            <div className="flex items-start md:items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 mt-1">
                  ...
                  This helps guides provide you with a more personalized
                  experience.
                </p>
              </div>
              <button
              ...
              <div className="space-y-6">
                ...
                {userData.savedGuides.length > 0 ? (
                  ...
                  <div className="text-center py-12 bg-gray-800 rounded-lg">
                    ...
                    <p className="text-gray-400 mt-2">
                      Save your favorite guides to find them quickly later
                    </p>
                    <Link href="/search-guides">
                      <div className="mt-4 inline-block px-4 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700">
                        Explore Guides
