        ...
        if (data.success) {
          ...
          setDestination(
            Array.from(
              new Set(
                data.bookings.map(
                  (booking) => booking.tour.destination.split(",")[0]
                )
              )
            )
          );
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex space-x-1">
                        ...
                        <button
                          className="p-1.5 text-gray-400 hover:text-gray-300 hover:bg-gray-600 rounded transition-colors"
                          title="More Options"
                        >
                          <FaEllipsisH size={14} />
                        </button>
