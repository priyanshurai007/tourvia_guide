...
export default function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  const isDashboard =
    pathname?.startsWith("/admin") || pathname?.startsWith("/guide-dashboard");
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Connecting students with local guides for authentic
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>
                    <a href="/cookies" className="hover:text-orange-400">
                      Cookie Policy
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://www.instagram.com/jyotiinfotech.04?igsh=MWM2cXB2MWVoaXh4dQ=="
                    target="_blank"
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 text-sm text-gray-400">
              <div className="flex flex-col md:flex-row md:justify-between items-center">
                <p>
                  &copy; {new Date().getFullYear()} Find Your Best Guide. All
                  rights reserved.
                </p>
