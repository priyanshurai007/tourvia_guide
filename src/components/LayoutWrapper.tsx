...
export default function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  const isDashboard = pathname?.startsWith('/admin') || pathname?.startsWith('/guide-dashboard');

  return (
    <>
      {!isDashboard && <ClientHeader />}
        ...
        <footer className="bg-gray-800 text-gray-300 py-8 border-t border-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-lg font-semibold mb-4">Find Your Best Guide</h3>
                <p className="text-sm text-gray-400">
                  Connecting travelers with local guides for authentic experiences around the world.
                </p>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><Link href="/search-guides" className="hover:text-orange-400">Find Guides</Link></li>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.instagram.com/jyotiinfotech.04?igsh=MWM2cXB2MWVoaXh4dQ==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-400">
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 text-sm text-gray-400">
              <div className="flex flex-col md:flex-row md:justify-between items-center">
                <p>&copy; {new Date().getFullYear()} Find Your Best Guide. All rights reserved.</p>
                <p className="mt-4 md:mt-0">
                  Design and Develop by{" "}
                  <a 
                    href="https://jyotiinfotech.netlify.app/" 
                    target="_blank"
